                                    ...
                                    <form class="forms-sample" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="productID" readonly
                                                value="<?= $row_edit['productID']?>" name="id">
                                        </div>
                                        <div class="form-group">
                                            <label for="productName">Product Name: </label>
                                            <input type="text" class="form-control" id="productName"
                                                placeholder="Enter product name" value="<?= $row_edit['productName']?>"
                                                name="name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="../../image/products/<?= $row_edit['productImage'] ?>"
                                                height="80px" width="70px" alt="no image">
                                            <input type="hidden" name="old_image"
                                                value="<?= $row_edit['productImage'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="details" class="form-control" id="productDetail" rows="7"
                                                name="details">
                                                <?=$row_edit['productDetail']?>
                                            </textarea>
                                        </div>
                                        <div class=" form-group">
                                        ...
                                        <a href="product.php" class="btn btn-light">Back</a>
                                    </form>
                                </div>
                            </div>
                        </div>
