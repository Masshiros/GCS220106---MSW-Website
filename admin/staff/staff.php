                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="btn btn-outline-info col-3"><a href="staff-add.php">Add
                                            Staff</a></p>
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#">
                                                        <img src=" ../../image/staff/<?= $row['staffImage'] ?>"
                                                            alt="No image">
                                                    </a>
                                                </td>
                                                <td><?= $row['staffName'] ?></td>
                                                ...
                                                <td>
                                                    <a href="staff-edit.php?id=<?= $row['staffID'] ?>" class="tags"
                                                        gloss="Edit this product">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="staff-delete.php?id=<?= $row['staffID']?>" class="tags"
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item"><a class="page-link"
                                                    href="staff.php?page=<?php $page>1 ? print (int)$page - 1 : print $pages ?>">Previous</a>
                                            </li>
                                            <?php
                                            ...
                                            <li class="page-item"><a
                                                    ...
                                                    href="staff.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                                            </li>
                                            <?php }?>
                                            <!-- Next button to change page: Page + 1  -->
                                            <li class="page-item"><a class="page-link"
                                                    href="staff.php?page=<?php $page<$pages ? print (int)$page + 1 : print "1" ?>">Next</a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <!-- end pagination -->
