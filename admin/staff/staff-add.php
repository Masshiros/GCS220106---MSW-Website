...
<?php
    ...
    if(isset($_POST['addnew'])) {
        try {
            ...
            $stmt->bindParam(1, $_POST['staffID']);            
			$stmt->bindParam(2, $_POST['staffImage']);	
			$stmt->bindParam(3, $_POST['staffName']);
			$stmt->bindParam(4, $_POST['staffPhone']);
			$stmt->bindParam(5, $_POST['staffEmail']);
			$stmt->bindParam(6, $_POST['staffRole']);
                                    ...
                                    <form class="forms-sample" method="POST" action="<?php ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="staffID"
                                                placeholder="Enter staffID" name="staffID">
                                        </div>
                                        <div class="form-group">
                                            <label>Image:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="staffName"
                                                placeholder="Enter staff Name" name="staffName">
                                        </div>
                                        <div class="form-group">
                                            <label for="staffPhone">Phone: </label>
                                            <input type="text" class="form-control" id="staffPhone"
                                                placeholder="Enter staff phone" name="staffPhone">
                                        </div>

                                        <div class="form-group">
                                            <label for="staffEmail">Email</label>
                                            <input type="text" class="form-control" id="staffEmail" rows="10"
                                                name="staffEmail"></input>
                                        </div>
                                        <div class="form-group">
                                            <label for="staffRole">Role</label>
                                            <input type="text" class="form-control" id="staffRole" rows="10"
                                                name="staffRole"></input>
                                        </div>
