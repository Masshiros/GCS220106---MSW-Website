                                    ...
                                    <form class="forms-sample" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="categoryID" readonly
                                                value="<?= $row_edit['categoryID']?>" name="id">
                                        </div>
                                        <div class="form-group">
                                            <label for="categoryName">Category Name: </label>
                                            <input type="text" class="form-control" id="categoryName"
                                                placeholder="Enter product name" value="<?= $row_edit['categoryName']?>"
                                                name="name">
                                        </div>

                                        <div class="form-group">
                                            <label for="descriptions">Category Descriptions</label>
                                            <textarea type="details" class="form-control" id="descriptions" rows="7"
                                                name="descriptions"><?= $row_edit['descriptions'] ?>
                                            </textarea>
                                        </div>
