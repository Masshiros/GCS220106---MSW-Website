                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="btn btn-outline-info col-3"><a href="category-add.php">Add
                                            Category</a></p>
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="category-edit.php?id=<?= $row['categoryID'] ?>"
                                                        class="tags" gloss="Edit this category">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="category-delete.php?id=<?= $row['categoryID']?>"
                                                        class="tags" gloss="Delete this category">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item"><a class="page-link"
                                                    href="category.php?page=<?php $page>1 ? print (int)$page - 1 : print $pages ?>">Previous</a>
                                            </li>
                                            <?php
                                            ...
                                            <li class="page-item"><a class="page-link"
                                                    href="category.php?page=<?php $page<$pages ? print (int)$page + 1 : print "1" ?>">Next</a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <!-- end pagination -->
