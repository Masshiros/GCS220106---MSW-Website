                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item"><a class="page-link"
                                                    href="order_detail.php?page=<?php $page>1 ? print (int)$page - 1 : print $pages ?>">Previous</a>
                                            </li>
                                            <?php
                                            ...
                                            <li class="page-item"><a
                                                    ...
                                                    href="order_detail.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                                            </li>
                                            <?php }?>
                                            <!-- Next button to change page: Page + 1  -->
                                            <li class="page-item"><a class="page-link"
                                                    href="order_detail.php?page=<?php $page<$pages ? print (int)$page + 1 : print "1" ?>">Next</a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <!-- end pagination -->
