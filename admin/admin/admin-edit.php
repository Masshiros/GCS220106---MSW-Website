...
<?php
    ...
    select s.staffID
    from staff as s, adminAccount as a
    where s.staffID = a.staffID) ";
    $stmt_staff = $conn->query($sql);
    $rows_staff = $stmt_staff->fetchAll();		
} 
    ...
    try {
        $sql = "select * from adminAccount where adminID = ?";
    ...
    if(isset($_POST['update'])) {
        try {
			$sql = "update adminAccount
                    set username =? , adminPassword =? , staffID =?
                    where adminID = ?";
			...
			$stmt->bindParam(3, $_POST['staffID']);
                                ...
                                <div class="card-body">
                                    <form class="forms-sample" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="adminID" readonly
                                                value="<?= $row_edit['adminID']?>" name="id">
                                        </div>
                                        <div class="form-group">
                                            <label for="username">Username: </label>
                                            <input type="text" class="form-control" id="username"
                                                placeholder="Enter product name" value="<?= $row_edit['username']?>"
                                                name="username">
                                        </div>
                                        <div class="form-group">
                                            <label for="adminPassword">Product Price: </label>
                                            <input type="text" class="form-control" id="adminPassword"
                                                placeholder="Enter product price"
                                                value="<?= $row_edit['adminPassword']?>" name="password">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="staffID" name="staffID">
                                                <?php foreach($rows_staff as $row)  { ?>
                                                <option value="<?=trim($row['staffID'])?>">
                                        ...
                                        <button type=" submit" class="btn btn-gradient-primary me-2" name="update">
                                            Submit</button>
