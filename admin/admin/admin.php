                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="btn btn-outline-info col-3"><a href="admin-add.php">Add
                                            Admin</a></p>
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin-edit.php?id=<?= $row['adminID'] ?>" class="tags"
                                                        gloss="Edit this product">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="admin-delete.php?id=<?= $row['adminID']?>" class="tags"
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item"><a class="page-link"
                                                    href="admin.php?page=<?php $page>1 ? print (int)$page - 1 : print $pages ?>">Previous</a>
                                            </li>
                                            <?php
                                            ...
                                            <li class="page-item"><a
                                                    ...
                                                    href="admin.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                                            </li>
                                            <?php }?>
                                            <!-- Next button to change page: Page + 1  -->
                                            <li class="page-item"><a class="page-link"
                                                    href="admin.php?page=<?php $page<$pages ? print (int)$page + 1 : print "1" ?>">Next</a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <!-- end pagination -->
