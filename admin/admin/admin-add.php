...
<?php
    ...
    if(isset($_POST['addnew'])) {
        try {
			...
			$stmt->bindParam(3, $_POST['adminPassword']);
			$stmt->bindParam(4, $_POST['staffID']);	
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" method="POST" action="admin-add.php">
                                        <div class="form-group">
                                            <label for="adminID">Admin ID:</label>
                                            <input type="text" class="form-control" id="adminID"
                                                placeholder="Enter AdminID" name="adminID">
                                        </div>
                                        <div class="form-group">
